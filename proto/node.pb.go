...
type DealManagementClient interface {
	...
	QuickBuy(ctx context.Context, in *QuickBuyRequest, opts ...grpc.CallOption) (*Deal, error)
}
...
func (c *dealManagementClient) QuickBuy(ctx context.Context, in *QuickBuyRequest, opts ...grpc.CallOption) (*Deal, error) {
	out := new(Deal)
...
type DealManagementServer interface {
	...
	// QuickBuy places BID order with the same parameters as given ASK order have,
	// then opens deal with this two orders.
	QuickBuy(context.Context, *QuickBuyRequest) (*Deal, error)
}
...
var _DealManagement_QuickBuyCmd = &cobra.Command{
	Use:   "quickBuy",
	Short: "Make the QuickBuy method call, input-type: sonm.QuickBuyRequest output-type: sonm.Deal",
	RunE: grpccmd.RunE(
		"QuickBuy",
...
var fileDescriptor9 = []byte{
	...
	,
}
